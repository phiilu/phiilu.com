...
> The **URL.createObjectURL()** static method creates a [DOMString][7] containing a URL representing the object given in the parameter. The URL lifetime is tied to the [document][8] in the window on which it was created. The new object URL represents the specified [File][9] object or [Blob][10] object. - [MDN][11]
