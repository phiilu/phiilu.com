...
![Vultr dashboard screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-1.png)

### Select your server type

Next you need to select your server type from the 4 existing ones.

![Vultr server types screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-2.png)
...
![Vultr server location screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-3.png)
...
![Vultr operating system options screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-4.png)
...
![Vultr preinstalled application options screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-5.png)
...
![Vultr server specs option screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-6.png)
...
![Vultr last steps before deployment screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-7.png)

### Server overview

After some time your new server should be visible in the dashboard.

![Vultr deployed server overview page screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-8.png)

Vultr will send you an Email with the IP of the server and how you can connect to it.

![Vultr success deployment email screenshot](../../assets/images/posts/create-your-first-vps-on-vultr-9.png)
