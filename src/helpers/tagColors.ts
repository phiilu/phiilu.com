...
const tags = {
  beginners: {
    ...
    hover: 'hover:bg-green-700 hover:text-white dark:hover:bg-green-600',
  ...
  openvpn: {
    ...
    bg: 'bg-openvpn-200 dark:bg-openvpn-700',
    text: 'text-openvpn-900 dark:text-white',
    mainColor: 'text-openvpn-500',
    hover: 'hover:bg-openvpn-700 hover:text-white dark:hover:bg-openvpn-600',
    description:
  ...
  'raspberry pi': {
    ...
    bg: 'bg-raspberrypi-200 dark:bg-raspberrypi-700',
    text: 'text-raspberrypi-800 dark:text-white',
    mainColor: 'text-raspberrypi-500',
    hover: 'hover:bg-raspberrypi-700 hover:text-white dark:hover:bg-raspberrypi-600',
  ...
  security: {
    ...
    hover: 'hover:bg-gray-700 hover:text-white dark:hover:bg-gray-600',
    description:
  ...
  'code editor': {
    ...
    bg: 'bg-vscode-200 dark:bg-vscode-700',
    text: 'text-vscode-800 dark:text-white',
    mainColor: 'text-vscode-500',
    hover: 'hover:bg-vscode-700 hover:text-white dark:hover:bg-vscode-600',
    description:
  ...
  vps: {
    ...
    hover: 'hover:bg-purple-700 hover:text-white dark:hover:bg-purple-600',
  ...
  vpn: {
    ...
    hover: 'hover:bg-indigo-700 hover:text-white dark:hover:bg-indigo-600',
    description:
  ...
  vultr: {
    name: 'vultr',
    slug: slugify('vultr'),
    bg: 'bg-vultr-200 dark:bg-vultr-700',
    text: 'text-vultr-800 dark:text-white',
    mainColor: 'text-vultr-500',
    hover: 'hover:bg-vultr-700 hover:text-white dark:hover:bg-vultr-600',
    description:
  ...
  ubuntu: {
    name: 'ubuntu',
    slug: slugify('ubuntu'),
    bg: 'bg-ubuntu-200 dark:bg-ubuntu-700',
    text: 'text-ubuntu-800 dark:text-white',
    mainColor: 'text-ubuntu-500',
    hover: 'hover:bg-ubuntu-700 hover:text-white dark:hover:bg-ubuntu-600',
    description:
  ...
  'hello world': {
    ...
    hover: 'hover:bg-red-700 hover:text-white dark:hover:bg-red-600',
  ...
  2020: {
    ...
    hover: 'hover:bg-pink-700 hover:text-white dark:hover:bg-pink-600',
    description:
  ...
  server: {
    ...
    hover: 'hover:bg-teal-700 hover:text-white dark:hover:bg-teal-600',
    description:
  ...
  serverless: {
    ...
    bg: 'bg-serverless-200 dark:bg-serverless-700',
    text: 'text-serverless-800 dark:text-white',
    mainColor: 'text-serverless-500',
    hover: 'hover:bg-serverless-700 hover:text-white dark:hover:bg-serverless-600',
    description:
  ...
  netlify: {
    ...
    bg: 'bg-netlify-200 dark:bg-netlify-700',
    text: 'text-netlify-800 dark:text-white',
    mainColor: 'text-netlify-500',
    hover: 'hover:bg-netlify-700 hover:text-white dark:hover:bg-netlify-600',
  ...
  html: {
    name: 'html',
    slug: slugify('html'),
    bg: 'bg-html-200 dark:bg-html-700',
    text: 'text-html-800 dark:text-white',
    mainColor: 'text-html-500',
    hover: 'hover:bg-html-700 hover:text-white dark:hover:bg-html-600',
    description:
  ...
  react: {
    ...
    hover: 'hover:bg-react-700 hover:text-react-gray-500',
  ...
  privacy: {
    ...
    hover: 'hover:bg-blue-700 hover:text-white dark:hover:bg-blue-600',
  ...
  'web apis': {
    ...
    hover: 'hover:bg-fuchsia-700 hover:text-white dark:hover:bg-fuchsia-600',
  ...
  'cloudflare workers': {
    ...
    hover: 'hover:bg-orange-700 hover:text-white dark:hover:bg-orange-600',
