...
![Fly.io app has been created and is visible on the dashboard ](../../assets/images/posts/deploy-meilisearch-to-fly-io-in-5-minutes-1.png)
...
![Fly.io Dashboard of the created app after it was deployed](../../assets/images/posts/deploy-meilisearch-to-fly-io-in-5-minutes-2.png)

Or simply run `fly open` 😎

![Meilisearch running on fly.io](../../assets/images/posts/deploy-meilisearch-to-fly-io-in-5-minutes-3.png)
...
![Meilisearch search preview is now secured using the master key](../../assets/images/posts/deploy-meilisearch-to-fly-io-in-5-minutes-4.png)
...
![Meilsearch search preview in action](../../assets/images/posts/deploy-meilisearch-to-fly-io-in-5-minutes-5.png)
