...
const tags = {
  ...
  "raspberry pi": {
    ...
    hover:
      "hover:bg-raspberrypi-500 hover:text-white dark:hover:bg-raspberrypi-400",
  ...
  vps: {
    ...
    description:
      "This tag shows posts that are taking advantage of Virtual Private Servers.",
  },
  vpn: {
    name: "vpn",
    slug: slugify("vpn"),
  ...
  serverless: {
    ...
    hover:
      "hover:bg-serverless-500 hover:text-white dark:hover:bg-serverless-400",
    description:
  ...
  netlify: {
    ...
    hover:
      "hover:bg-netlify-500 hover:text-white dark:hover:bg-netlify-400 dark:hover:text-black",
    description:
