...
const PostListItem = ({ post: { slug, title, description, published, icon, date, tags } }) => {
  return React.useMemo(
    () => (
      <article className="relative inline-block p-4 text-gray-900 rounded-md outline-none dark:text-gray-100 post-item hover:bg-gray-100 hover:text-gray-700 focus:bg-gray-100 focus:shadow-sm focus:text-gray-700 dark:hover:bg-gray-800">
